  ...
  return (
    <footer className="relative overflow-hidden border-t border-zinc-200/70 bg-white/70 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.02]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-[calc(1.5rem+env(safe-area-inset-bottom))] pt-8 sm:px-6 sm:py-10 md:pb-10">
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-1.5 border-t border-zinc-200/70 pt-4 text-center text-[12px] text-zinc-500 dark:border-white/10 dark:text-zinc-500 sm:mt-8 sm:flex-row sm:pt-5 sm:text-left">
          ...
          <p className="shrink-0 font-mono font-semibold">OFFLINE READY</p>
        </div>
      </div>
    </footer>
  );
